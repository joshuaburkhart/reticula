...
rxns_w_srp050223_ensembls.df <- ensembl2rxns.df %>% dplyr::filter(V1 %in% reactome_ensembl_ids)
rxns_w_srp050223_ensembls.df$V1 <- as.character(rxns_w_srp050223_ensembls.df$V1)
rxns_w_srp050223_ensembls.df$V2 <- as.character(rxns_w_srp050223_ensembls.df$V2)
for(i in 1:nrow(rxns_w_srp050223_ensembls.df)){
  ens_id <- rxns_w_srp050223_ensembls.df$V1[i]
  rxn_id <- rxns_w_srp050223_ensembls.df$V2[i]
