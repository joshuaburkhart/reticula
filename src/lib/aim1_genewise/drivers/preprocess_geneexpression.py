# based on https://gist.githubusercontent.com/wckdouglas/3f8fb27a3d7a1eb24c598aa04f70fb25/raw/a9f019ae71f7ae46d576b2c4603a8123753b29eb/py_deseq.py
import pandas as pd
...
def preprocess():
    pass
    ##TODO: consume some parsed argument/state object we can load from a local configuration file and share among other reticula scripts
    # parse args
    ...
    # package.
    # clue.io API KEY = "bc0e7da0eaf926adaa8663858938401a"
