...
model_fn = '/home/jgburk/PycharmProjects/reticula/data/gtex/output/zsl_fully_trained_pytorch_gtex_gnn_model.pt'
output_fn = '/home/jgburk/PycharmProjects/reticula/data/tcga/output/zsl_gnn_predictions.tsv'
