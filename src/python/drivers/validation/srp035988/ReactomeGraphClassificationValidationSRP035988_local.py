...
output_fn = '/home/jgburk/PycharmProjects/reticula/data/SRP035988/output/predictions.tsv'
...
model_save_name = f'tuned_pytorch_srp035988_model.pt'
path = f'/home/jgburk/PycharmProjects/reticula/data/SRP035988/output/{model_save_name}'
