...
output_fn = '/home/jgburk/PycharmProjects/reticula/data/SRP050223/output/predictions.tsv'
...
model_save_name = f'tuned_pytorch_srp050223_model.pt'
path = f'/home/jgburk/PycharmProjects/reticula/data/SRP050223/output/{model_save_name}'
