...
def interpolate_template(template_path: str,
                         instance_name: str,
...
def generate_executables() -> None:
    interpolate_template(os.getenv(key='buildTemplPath'),
                         os.getenv(key='buildInstFilNme'),
                         os.getenv(key='buildInstExt'),
                         0o744)  # set permissions to "rwxr--r--"
    interpolate_template(os.getenv(key='dockerTemplPath'),
                         os.getenv(key='dockerInstFilNme'),
                         os.getenv(key='dockerInstExt'),
                         0o644)  # set permissions to "rw-r--r--"
    interpolate_template(os.getenv(key='slurmTemplPath'),
